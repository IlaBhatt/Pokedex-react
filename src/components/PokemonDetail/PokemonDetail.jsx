...
const PokemonDetail = () => {
    ...
    const pokemonDataDetail = pokemonData.results.filter(function(pokemon) { return pokemon.details.id.toString() === pokemonId});
  ...
  return (
    <div className='pokemon-detail-overlay'>
        ...
        <div className='pokemon-detail'>
            <img style={gradientStyle} src={pokemonDetails.sprites.front_shiny} className='img-card' alt={pokemonDetails.name}/>  
                ...
                <div className='evolution-chain'>
                    {
                        ...
                        <div className='img'>
                            <img style={getBgColor(pokemonData.details)} src={pokemonData.details.sprites.front_shiny} className='img-card' key={index} alt={pokemonDetails.name}/>
